...
import { FlatList, FlatListProps, GestureResponderEvent, LayoutChangeEvent, ListRenderItemInfo, NativeScrollEvent, ViewStyle } from 'react-native';
...
export default class AppIntroSlider<ItemT = any> extends React.Component<Props<ItemT>, State> {
    ...
    _InvisibleButton: () => JSX.Element;
    _renderInvisibleButton: () => false | JSX.Element;
