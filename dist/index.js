...
class AppIntroSlider extends React.Component {
    constructor() {
        ...
        this._InvisibleButton = () => (<react_native_1.View style={{ ...styles.transparentBottomButton }}>
      <react_native_1.Text style={{ ...styles.buttonText, color: 'rgba(0,0,0,0)' }}>Inv</react_native_1.Text>
    </react_native_1.View>);
        this._renderInvisibleButton = () => !this.props.centerDoneButton &&
            this._renderButton('Invisible', 'Invisible', () => { }, this.props.renderInviButton
        ...
        this._renderPagination = () => {
            ...
            const secondaryButton = (isLastSlide &&
